<?php
include 'C:\xampp\htdocs\Ecommerce\header\header.php';
?>
...
<body onload='color(2);'>
    // when you want to go to the top
...
<!--Signup page-->
			<div id='content'/>
					...
					<section>
						<article id='home'>
							<h1>
                            <p> If your are not moving closer to what you want in Sales (or in life),Your are probably not doing enough.</p>
								<br><br>
								<br>
                                <p>By</p>
				<p>Jack Canfield</p>
				...
				<hr>
						<article id='about'>
							...
							<div id='about1'>
								...
								<br>
								<h3>Who We Are</h3>
								We are an online  shop that offers variety of  products to our customers and allow them to purchase online
								<!--an image goes here-->
							</div >
							...
							<div id='about3'>
								...
								We also promote the juakali industry by allowing them to sell their products on our online platform.
							</div>
						</article>
				<hr>
						<article id='product'>
							...
							<div id='prod1'>
                                <!--link with pages when yu click an image-->
								<a href="\Ecommerce\tables_page\table.php"><img src="images\jembe1.jpg" class='prod_images'></a>
								Agricultural
							</div>

							<div id='prod3'>
								<a href="\Ecommerce\couch_page\couch.php"><img src="images\spoon1.jpg" class='prod_images'></a>
								Kitchen
							</div>

							<div id='prod4'>
								<a href="\Ecommerce\beds\beds.php"><img src="images\box.jpg" class='prod_images'></a>
								Others
							</div>
			...
			<hr>
						<article id='work'>
							...
							<div id='work2'>
								...
								and sell their  items online. If you are interested <a href="\Ecommerce\retailer_page\signup.php">register</a> with us and start working.Take your
